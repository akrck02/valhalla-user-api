...
func main() {
	...
	apicommon.Start(
		...
		[]models.Endpoint{
			...
			{Path: "edit", Method: http.HTTP_METHOD_PATCH, Listener: services.EditUserHttp, Secured: true},
			{Path: "edit/email", Method: http.HTTP_METHOD_PATCH, Listener: services.EditUserEmailHttp, Secured: true},
			{Path: "edit/profilepic", Method: http.HTTP_METHOD_PATCH, Listener: services.EditUserProfilePictureHttp, Secured: true},
			...
			{Path: "role/edit", Method: http.HTTP_METHOD_PATCH, Listener: services.EditRoleHttp, Secured: true},
			...
			{Path: "team/edit", Method: http.HTTP_METHOD_PATCH, Listener: services.EditTeamHttp, Secured: true},
